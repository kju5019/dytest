...
public class OrderApp {
	...
	public static void main(String[] args) {
		...
		menuList1.add(new Coffee("아메리카노", 3000, "에티오피아 예가체프"));		//0
		menuList1.add(new Coffee("카푸치노", 3500, "케냐 오클랜드"));			//1
		menuList1.add(new Ade("레몬에이드", 4000, "레몬, 시럽"));				//2
		//menuList1.get(i).
		//menyList.get(i).getPrice()
